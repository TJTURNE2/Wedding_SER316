...
public class Configuration {
	...
	static LoadableProperties config  = null;
	...
	static String getConfigPath() {
		String p;
		if (currentUser != null) {
			p = Util.getEnvDir()+currentUser+File.separator+"memoranda.properties";
		}
		else {
			p = Util.getEnvDir()+"memoranda.properties";
		}
