...
public class PSPNewTimeLogEntryDialog extends JDialog {
	...
	public static void NewDialog() throws IOException {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				PSPNewTimeLogEntryDialog nd = new PSPNewTimeLogEntryDialog();
				nd.setVisible(true);
			}
		});
	...
	public PSPNewTimeLogEntryDialog() {
		...
		lblNewProject.setIcon(new ImageIcon(
				PSPNewTimeLogEntryDialog.class.getResource("/net/sf/memoranda/ui/htmleditor/resources/icons/filenew.png")));
